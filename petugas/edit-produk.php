                ...
                <div class="card-body">
                    <form class="pt-3 mt-3" action="" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" name="NamaProduk" class="form-control" value="<?php echo $name; ?>" id="" placeholder="Enter Nama Barang" name="Nama Barang">
                        </div>
                        <div class="row">
                            <div class="form-group col-sm-6">
                                <p class="col-form-label" for="">Harga</p>
                                <input type="number" name="Harga" class="form-control" value="<?php echo $harga; ?>" id="" placeholder="Enter Harga" name="Harga">
                            </div>
                            <div class="form-group col-sm-6">
                                <p class="col-form-label" for="">Stok</p>
                                <input type="number" name="stok" class="form-control" value="<?php echo $stok; ?>" id="" placeholder="Enter Stok" name="Stok">
                            </div>
                        </div>
